...
export function FlashCard({ card, revealed, onReveal }: FlashCardProps) {
  return (
    <div className="rounded-xl border border-border bg-card p-6 flex flex-col gap-4 min-h-48">
      <div
      ...
      {!revealed ? (
        ...
        <div
          className="card-content text-card-foreground border-t border-border pt-4 mt-auto"
