...
function renderNav() {
  ...
  nav.innerHTML = `
    <div class="max-w-lg mx-auto px-4 flex items-center justify-between h-14">
      <a href="#/" class="flex items-baseline gap-1.5 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
        <span class="font-bold text-lg text-gray-900 dark:text-gray-100">Markcards</span>
        <span class="text-[10px] text-gray-400 dark:text-gray-500">v${__APP_VERSION__}</span>
      </a>
